...
var parser = __nccwpck_require__(613);
var compiler = __nccwpck_require__(763);
...
const toml = __nccwpck_require__(132);

const configPathFromEnv = process.env.TAURI_CONFIG_PATH;

function main(configPathFromEnv) {
  let version = null;
